...
class RectangularRoom(object):
    ...
    def __init__(self, width, height):
        ...
        self.nonCleanAmount = width * height
    ...
    def cleanTileAtPosition(self, pos):
        ...
        pos: a Position
        """
        if self.tiles[int(pos.getX())][int(pos.getY())] != 0:
            self.tiles[int(pos.getX())][int(pos.getY())] = 0
            self.nonCleanAmount -= 1
    ...
    def getNumCleanedTiles(self):
        ...
        returns: an integer
        """
        return self.size - self.nonCleanAmount
    ...
    def getRandomPosition(self):
        ...
        """
        return Position(random.randint(0, self.width - 1), random.randint(0, self.height))
...
class StandardRobot(Robot):
    ...
    def updatePositionAndClean(self):
        ...
        while (self.position == startPosition):
...
def runSimulation(num_robots, speed, width, height, min_coverage, num_trials,
    ...
    """
    results = []
    totalCoverage = min_coverage * width * height
    for trial in range(num_trials):
        ...
        while (room.getNumCleanedTiles() <= totalCoverage):
            timeSteps += 1
            for robot in robots:
